...
export const uiText = {
  ja: {
    ...
    home: {
      ...
      openSettings: '設定を開く',
      emptyTitle: '最初のリマインダーを作成しましょう',
      emptyBody: '時間、キャラクター、ひとことメモを決めるだけで開始できます。',
      emptyAction: 'リマインダーを作成',
      sampleSync: 'サンプル同期',
      active: '進行中',
      completed: '完了',
      complete: '完了',
      snoozeTenMinutes: '10分後',
      freeCueLimit: (limit: number) => `Free: リマインダー${limit}件まで`,
    },
    reminderForm: {
      createKicker: 'New Reminder',
      editKicker: 'Edit Reminder',
      title: 'リマインダーを設定',
      titleLabel: 'タイトル',
      noteLabel: 'メモ',
    ...
    chat: {
      ...
      reminderFallbackTitle: 'チャットからリマインダー',
    ...
    pro: {
      kicker: 'Pro',
      title: 'CueUp Pro',
      benefits: ['リマインダーとAI利用枠を拡張', 'フォルダ/タグで整理', '通知履歴と同期を強化'],
    ...
    errors: {
      ...
      freeCueLimit: 'Free プランのリマインダー上限に達しました。',
  ...
  en: {
    ...
    onboarding: {
      title: 'Start CueUp',
      body: 'Get reminders for plans and todos in the voice of your chosen character.',
      allowNotifications: 'Allow notifications',
      continueSignedIn: 'Sign in and start',
      later: 'Set up later',
      loginContinue: 'Sign in to continue',
      permissionTitle: 'Notifications are off',
      permissionBody: 'Allow notifications in Settings to receive character-voiced reminders.',
    ...
    home: {
      ...
      emptyTitle: 'Create your first reminder',
      emptyBody: 'Pick a time, a character, and one short note to get started.',
      emptyAction: 'Create reminder',
      sampleSync: 'Load sample',
      active: 'Active',
      completed: 'Done',
      complete: 'Done',
      snoozeTenMinutes: '10 min',
      freeCueLimit: (limit: number) =>
        limit === 1 ? 'Free: 1 reminder' : `Free: ${limit} reminders`,
    },
    reminderForm: {
      createKicker: 'New Reminder',
      editKicker: 'Edit Reminder',
    ...
    character: {
      ...
      defaultDetail: 'Voice used for reminder notifications',
    ...
    chat: {
      ...
      send: 'Send',
      createCue: 'Make reminder',
      simulateFailure: 'AI failure',
      resend: 'Resend',
      assistantNameFallback: 'Character',
      aiFailed: 'Could not get an AI response.',
      reminderFallbackTitle: 'Reminder from chat',
    ...
    pro: {
      ...
      title: 'CueUp Pro',
      benefits: [
        'Raise reminder and AI limits',
        'Organize with folders and tags',
        'Extend history and sync',
      ],
      organizationBenefits: [
        'Increase active reminders',
        'Organize with folders and tags',
    ...
    errors: {
      ...
      freeCueLimit: 'You reached the Free plan reminder limit.',
