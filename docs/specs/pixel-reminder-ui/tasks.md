...
- [x] Run Expo Go or simulator smoke QA for onboarding, Home, reminder form, character picker, History, Chat, Pro/Store, and Settings. Covers REQ-011. See `qa-report.md`.
...
- [x] Document naming and Pro-limit deferrals against `design.md`, `release-qa.md`, and `qa-report.md`. Covers open questions.
